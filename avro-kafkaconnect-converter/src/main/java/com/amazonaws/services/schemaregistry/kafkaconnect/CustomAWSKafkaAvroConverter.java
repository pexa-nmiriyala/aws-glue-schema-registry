...
@Slf4j
@Data
public class CustomAWSKafkaAvroConverter implements Converter {
    private AWSKafkaAvroSerializer serializer;
    private AWSKafkaAvroDeserializer deserializer;
    private org.apache.kafka.connect.json.JsonDeserializer jsonDeserializer;
     ...
     */
    public CustomAWSKafkaAvroConverter() {
        ...
        jsonDeserializer = new org.apache.kafka.connect.json.JsonDeserializer();
    }
    ...
    public SchemaAndValue toConnectData(String topic, byte[] value) {
        ...
        try {
            ...
            // If the primary deserialization fails, try with the StringDeserializer
            try {
                deserialized = jsonDeserializer.deserialize(topic, value);
                return new SchemaAndValue(null, deserialized);
            } catch (Exception ex) {
                throw new DataException("Converting byte[] to Kafka Connect data failed due to serialization error: ", ex);
            }
        }
